    ...
    littleStar() {
        ...
        if (sheet instanceof HTMLDivElement
            ...
            if (!sheet.classList.value.includes('hidden')) {
                if (littleStar[index].syllableNames[arrIndex] === ((findWhiteKeys === null || findWhiteKeys === void 0 ? void 0 : findWhiteKeys.syllableName) || (findBlackKeys === null || findBlackKeys === void 0 ? void 0 : findBlackKeys.syllableName))) {
