    ...
    keys.forEach((key) => {
        ...
        if (key instanceof HTMLButtonElement) {
            ...
            if (e.code === keyboard && !e.repeat) {
                ...
                audio.play();
                (_a = key.firstElementChild) === null || _a === void 0 ? void 0 : _a.classList.add('key-active');
            }
        }
    });
    sharp.forEach((key) => {
...
function handleKeyup(e) {
    ...
    keys.forEach((key) => {
        ...
        if (key instanceof HTMLButtonElement) {
            const keyboard = key.getAttribute('data-keyboard');
            if (e.code === keyboard) {
                (_a = key.firstElementChild) === null || _a === void 0 ? void 0 : _a.classList.remove('key-active');
            }
        }
    });
    sharp.forEach((key) => {
