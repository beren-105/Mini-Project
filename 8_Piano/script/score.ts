...
import { musics, littleStar, happyBirthdey } from './pianoItems.js';
    ...
    littleStar() {
        ...
        if (musicDiv instanceof HTMLDivElement
            ...
            if (!musicDiv.classList.value.includes('hidden')) {
                ...
                if(littleStar[littleStarIndex].syllableNames[arrIndex] === (findWhiteKeys?.syllableName || findBlackKeys?.syllableName)) {
