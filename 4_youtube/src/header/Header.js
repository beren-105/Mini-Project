...
function Header(props) {
    ...
    const profile = (
        <div className="flex items-center shrink-0">
            <svg className="w-10 p-2 dark:fill-white" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M14,13h-3v3H9v-3H6v-2h3V8h2v3h3V13z M17,6H3v12h14v-6.39l4,1.83V8.56l-4,1.83V6 M18,5v3.83L22,7v8l-4-1.83V19H2V5H18L18,5 z"></path></g></svg>
            <svg className="w-10 p-2 dark:fill-white" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M10,20h4c0,1.1-0.9,2-2,2S10,21.1,10,20z M20,17.35V19H4v-1.65l2-1.88v-5.15c0-2.92,1.56-5.22,4-5.98V3.96 c0-1.42,1.49-2.5,2.99-1.76C13.64,2.52,14,3.23,14,3.96l0,0.39c2.44,0.75,4,3.06,4,5.98v5.15L20,17.35z M19,17.77l-2-1.88v-5.47 c0-2.47-1.19-4.36-3.13-5.1c-1.26-0.53-2.64-0.5-3.84,0.03C8.15,6.11,7,7.99,7,10.42v5.47l-2,1.88V18h14V17.77z"></path></g></svg>
            
            <div className="relative">
                <div
                    className="p-2 mx-2 w-8 h-8 bg-zinc-200 rounded-full"
                    onClick={() => settingClick(openSettion)}
                ></div>
                <Setting
                    openSettion={openSettion}
                    mode={mode}
            ...
            <nav className="flex items-center justify-between h-14">
                ...
                <div className="flex items-center ml-4 shrink-0">
                    <button
                        ...
                        type="button"
                        className="hover:bg-zinc-200 rounded-full transition dark:hover:bg-zinc-900"
                    >
        ...
        {openSettion ?
            <div className="w-72 py-2 absolute botton-0 right-0 bg-white text-left rounded-xl shadow-2xl z-20 dark:bg-zinc-800">
                <ul>
                    {props.login ?
                    <>
                    <li className="flex py-2 px-4 mb-4 border-b">
                        <div className="p-2 mr-4 w-8 h-8 bg-zinc-200 rounded-full"></div>
                        <div>
                            <p>유저 이름</p>
                            <p>아이디</p>
                        </div>
                    </li>
                    <li className="flex items-center px-2" onClick={props.auth.signOut}>
                        <svg className="w-10 p-2 mr-2 bg-white hover:bg-zinc-200 hover:rounded-full transition dark:fill-white dark:bg-black" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M20,3v18H8v-1h11V4H8V3H20z M11.1,15.1l0.7,0.7l4.4-4.4l-4.4-4.4l-0.7,0.7l3.1,3.1H3v1h11.3L11.1,15.1z"></path></g></svg>
                        <a className="block" href="#">로그아웃</a>
                    </li>
                    </>
