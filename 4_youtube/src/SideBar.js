...
function SideBar() {
    ...
    const sideNav1 = [
        {id: 'nav0', name:'홈', icon: <svg className="w-10 p-2 mx-2" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M4,10V21h6V15h4v6h6V10L12,3Z"></path></g></svg>},
        {id: 'nav1', name:'Shorts', icon: <svg className="w-10 p-2 mx-2" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g height="24" viewBox="0 0 24 24" width="24"><path d="M10 14.65v-5.3L15 12l-5 2.65zm7.77-4.33c-.77-.32-1.2-.5-1.2-.5L18 9.06c1.84-.96 2.53-3.23 1.56-5.06s-3.24-2.53-5.07-1.56L6 6.94c-1.29.68-2.07 2.04-2 3.49.07 1.42.93 2.67 2.22 3.25.03.01 1.2.5 1.2.5L6 14.93c-1.83.97-2.53 3.24-1.56 5.07.97 1.83 3.24 2.53 5.07 1.56l8.5-4.5c1.29-.68 2.06-2.04 1.99-3.49-.07-1.42-.94-2.68-2.23-3.25zm-.23 5.86l-8.5 4.5c-1.34.71-3.01.2-3.72-1.14-.71-1.34-.2-3.01 1.14-3.72l2.04-1.08v-1.21l-.69-.28-1.11-.46c-.99-.41-1.65-1.35-1.7-2.41-.05-1.06.52-2.06 1.46-2.56l8.5-4.5c1.34-.71 3.01-.2 3.72 1.14.71 1.34.2 3.01-1.14 3.72L15.5 9.26v1.21l1.8.74c.99.41 1.65 1.35 1.7 2.41.05 1.06-.52 2.06-1.46 2.56z"></path></g></svg>},
        {id: 'nav2', name:'구독', icon: <svg className="w-10 p-2 mx-2" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M10,18v-6l5,3L10,18z M17,3H7v1h10V3z M20,6H4v1h16V6z M22,9H2v12h20V9z M3,10h18v10H3V10z"></path></g></svg>}
    ]

    const sideNav2 = [
        {id: 'nav3', name: '보관함', icon: <svg className="w-10 p-2 mx-2" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M11,7l6,3.5L11,14V7L11,7z M18,20H4V6H3v15h15V20z M21,18H6V3h15V18z M7,17h13V4H7V17z"></path></g></svg>},
        {id: 'nav4', name: '시청기록', icon: <svg className="w-10 p-2 mx-2" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M14.97,16.95L10,13.87V7h2v5.76l4.03,2.49L14.97,16.95z M22,12c0,5.51-4.49,10-10,10S2,17.51,2,12h1c0,4.96,4.04,9,9,9 s9-4.04,9-9s-4.04-9-9-9C8.81,3,5.92,4.64,4.28,7.38C4.17,7.56,4.06,7.75,3.97,7.94C3.96,7.96,3.95,7.98,3.94,8H8v1H1.96V3h1v4.74 C3,7.65,3.03,7.57,3.07,7.49C3.18,7.27,3.3,7.07,3.42,6.86C5.22,3.86,8.51,2,12,2C17.51,2,22,6.49,22,12z"></path></g></svg>}
    ]
    

    return(
        <>
        <section className="fixed top-0 left-0 bg-white w-56 h-full z-30 -translate-x-56 xl:translate-x-0">
        {/* -translate-x-56 */}
            {/* 로고 */}
            <div className="flex items-center ml-4">
                <svg className="w-10 p-2 hover:bg-gray-200 rounded-full transition" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M21,6H3V5h18V6z M21,11H3v1h18V11z M21,17H3v1h18V17z"></path></g></svg>
                <a
            ...
            <div className="px-4 text-sm h-full overflow-y-auto">
                <ul className="py-2 border-b">
                    {sideNav1.map(sideNav => (
                        <li key={sideNav.id}><a className="flex items-center hover:bg-gray-200 rounded-xl">
                            {sideNav.icon}
                ...
                <div className="p-4 border-b">
                    ...
                    <button className="w-22 border rounded-full mt-2">
                ...
                <div className="p-4">
                    <ul className="flex flex-wrap gap-x-2 text-gray-500 mb-4">
                        <li><a href="#">정보</a></li>
                        <li><a href="#">보도자료</a></li>
